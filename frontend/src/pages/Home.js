        ...
        <section className="pt-20 md:pt-40">
          <div className="container mx-auto px-8 lg:flex">
            <div className="text-center lg:text-left lg:w-1/2">
              ...
              Real-Time Crypto Insights at Your Mouseclick</h1>
              <p className="text-xl lg:text-2xl mt-6 font-light">
              Your Personalized Dashboard for Cryptocurrency Tracking and Market Insights
              </p>
            ...
            <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
              <div className="flex-1 px-3">
                ...
                >
                  ...
                  <p className="mt-4">
                  Live Market Tracking: Access real-time data on cryptocurrency prices, market trends, and top-performing coins, all updated instantly via the CoinGecko API.
                  </p>
                </div>
              </div>
              <div className="flex-1 px-3">
                ...
                >
                  ...
                  <p className="mt-4">
                  Personalized Watchlist: Create and manage a customized watchlist to monitor your favorite cryptocurrencies, with instant updates on their performance.
                  </p>
                </div>
              </div>
              <div className="flex-1 px-3">
                ...
                >
                  ...
                  <p className="mt-4">
                  Trending Analysis: Stay informed with insights on trending cryptocurrencies, helping you identify market movements and investment opportunities.
                  </p>
                </div>
              </div>
            </div>
